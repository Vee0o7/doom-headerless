...
#ifdef DIV2
#define V_CopyRectDiv2All __V_CopyRectDiv2All
#define V_DrawPatchDiv2All __V_DrawPatchDiv2All
#else
#define V_CopyRectDiv2All V_CopyRect
#define V_DrawPatchDiv2All V_DrawPatch
#endif
